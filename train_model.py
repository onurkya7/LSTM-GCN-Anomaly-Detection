...
X_train = np.hstack((train_data[numeric_cols].fillna(0).values, train_info_features))
y_train = train_data['attack_type'].values

X_test = np.hstack((test_data[numeric_cols].fillna(0).values, test_info_features))
